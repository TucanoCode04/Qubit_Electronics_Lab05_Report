\chapter{Analysis of the output files}

The generated outputs were inspected at both the electrostatic and quantum
levels. The \texttt{n} file is used to verify the carrier distribution and the
depletion of the active region, while the \texttt{q} file is used to analyse
the confined single-particle states.

\newpage
\section{Analysis of the \texttt{n} file}
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.72\textwidth]{Images/Nfile/Slice_file_n_lab5.png} 
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.72\textwidth, height=0.48\textwidth, keepaspectratio]{Images/Nfile/Plot_file_n_lab5.png} 
