...
dots, indicating a weakly coupled double-dot regime. The fourth excited state,
whose energy lies close to the barrier saddle, has a visible density in the
inter-dot region and therefore shows the clearest bonding-like hybridized
character among the computed levels.
...
with the onset of tunnel-mediated hybridization. Since the output stores
\(|\psi|^2\), the bonding assignment is based on the spatial density in the
barrier region; a strict bonding/antibonding phase distinction would require
the signed wavefunction.
